...
class FPN(nn.Module):
    ...
    def forward(self, x):
        ...
        return ([p2_out, p3_out, p4_out, p5_out, p6_out], [c2_out, c3_out, c4_out, x])
...
class MaskRCNN(nn.Module):
    ...
    def build(self, config):
        ...
        # MIDAS SCRATCH
        self.midas_scratch = MidasScratch()
    ...
    def load_weights(self, filepath, midas_loader_func):
    ...
    def predict(self, input, mode, use_nms=1, use_refinement=False, return_feature_map=False):
        ...
        ## Feature extraction
        fpn_out = self.fpn(molded_images)
        [p2_out, p3_out, p4_out, p5_out, p6_out] = fpn_out[0]
        [layer_1, layer_2, layer_3, layer_4] = fpn_out[1]

        # Midas Layer Output
        midas_depth = self.midas_scratch(*fpn_out[1])
        ...
        if mode == 'inference':
            ...
            return [detections, mrcnn_mask, depth_np, midas_depth]
            ...
            return [rpn_class_logits, rpn_bbox, target_class_ids, mrcnn_class_logits, target_deltas, mrcnn_bbox, target_mask, mrcnn_mask, target_parameters, mrcnn_parameters, rois, depth_np, midas_depth]
            ...
            info = [rpn_class_logits, rpn_bbox, target_class_ids, mrcnn_class_logits, target_deltas, mrcnn_bbox, target_mask, mrcnn_mask, target_parameters, mrcnn_parameters, detections, detection_masks, roi_gt_parameters, roi_gt_masks, rpn_rois, roi_features, roi_indices, midas_depth]
